...
export default class {
  ...
  getUser (username) {
    return this.db.prepare(`SELECT id, username, name, handicap, isAdmin FROM ${ENUM.Users} WHERE username = ?`).get(username)
  }

  getUserPassword (username) {
    return this.db.prepare(`SELECT password FROM ${ENUM.Users} WHERE username = ?`).get(username).password
  }

  getUsers () {
    return this.db.prepare(`SELECT id, username, name, handicap, isAdmin FROM ${ENUM.Users}`).all()
  }
